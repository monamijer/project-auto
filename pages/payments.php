...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['action'] ?? '') === 'add') {
    ...
    if ($msg === 'OK') {
        ...
        notifyAdmins('Nouveau paiement', 'Un paiement de ' . $_POST['montant'] . '.00$ a été enregistré.', '/pages/payments.php');
    } else {
        $error = $msg;
    }
}
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tr>
                    ...
                    <td class="text-end pe-3">
                        ...
                        <a href="?delete=<?= $row[
                            'id'
                        ] ?>&page=<?= $page ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Supprimer ?')" title="Supprimer"><i class="bi bi-trash"></i></a>
                        <?php endif; ?>
                    </td>
                </tr>
                <?php endforeach; ?>
