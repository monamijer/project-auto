...
if ($filter !== '') {
    $lessons = array_filter($lessons, fn($l) => $l['statut'] === $filter);
    $lessons = array_values($lessons);
}
$total = count($lessons);
...
<div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
    <div>
        <h1 class="h3 mb-1"><i class="bi bi-calendar-check me-2 text-primary"></i>Leçons</h1>
        <p class="text-muted mb-0"><?= $total ?> leçon(s)</p>
    </div>
...
<div class="card shadow-sm border-0">
    <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
        <h5 class="mb-0"><i class="bi bi-list-ul me-2"></i>Liste des leçons</h5>
