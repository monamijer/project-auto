...
$notifCountSidebar = isAdmin() ? (int) $pdo->query("SELECT COUNT(*) FROM notifications WHERE destinataire='all' AND lu=0")->fetchColumn() : 0;
...
<nav class="sidebar" id="appSidebar">
    ...
    <div class="sidebar-body">
        ...
        <ul class="nav flex-column px-2">
            ...
            <li class="nav-item"><a class="nav-link <?= $currentFile === 'instructors.php'
                ? 'active'
                : '' ?>" href="<?= BASE_URL ?>/pages/instructors.php"><i class="bi bi-person-badge me-2"></i>Moniteurs</a></li>
            <li class="nav-item"><a class="nav-link <?= $currentFile === 'vehicles.php'
                ? 'active'
                : '' ?>" href="<?= BASE_URL ?>/pages/vehicles.php"><i class="bi bi-car-front me-2"></i>Véhicules</a></li>
            <li class="nav-item"><a class="nav-link <?= $currentFile === 'lessons.php'
                ? 'active'
                : '' ?>" href="<?= BASE_URL ?>/pages/lessons.php"><i class="bi bi-calendar-check me-2"></i>Leçons</a></li>
            ...
            <li class="nav-item"><a class="nav-link <?= $currentFile === 'enrollments.php'
                ? 'active'
                : '' ?>" href="<?= BASE_URL ?>/pages/enrollments.php"><i class="bi bi-journal-text me-2"></i>Inscriptions</a></li>
            <li class="nav-item"><a class="nav-link <?= $currentFile === 'exams.php'
                ? 'active'
                : '' ?>" href="<?= BASE_URL ?>/pages/exams.php"><i class="bi bi-clipboard-check me-2"></i>Examens</a></li>
            <?php if (hasPermission('gestion_documents')): ?>
            <li class="nav-item"><a class="nav-link <?= $currentFile === 'documents.php'
                ? 'active'
                : '' ?>" href="<?= BASE_URL ?>/pages/documents.php"><i class="bi bi-file-earmark-arrow-up me-2"></i>Documents</a></li>
            <?php endif; ?>
        </ul>
        ...
        <ul class="nav flex-column px-2">
            <li class="nav-item"><a class="nav-link <?= $currentFile === 'export.php'
                ? 'active'
                : '' ?>" href="<?= BASE_URL ?>/pages/export.php"><i class="bi bi-file-earmark-spreadsheet me-2"></i>Export Excel</a></li>
            <li class="nav-item"><a class="nav-link <?= $currentFile === 'rapport_pdf.php'
                ? 'active'
                : '' ?>" href="<?= BASE_URL ?>/pages/rapport_pdf.php"><i class="bi bi-file-earmark-pdf me-2"></i>Rapport PDF</a></li>
        </ul>
        <?php endif; ?>
        ...
        <ul class="nav flex-column px-2">
            ...
            <li class="nav-item"><a class="nav-link <?= $currentFile === 'corbeille.php'
                ? 'active'
                : '' ?>" href="<?= BASE_URL ?>/pages/corbeille.php"><i class="bi bi-trash3 me-2"></i>Corbeille</a></li>
            <?php endif; ?>
